...
{
    public class MySQLDataOperation : DataOperation, IDataOperation
    {
        public MySQLDataOperation(IDBAdapter adapter, string connectCommand, string dbType) : base(adapter, connectCommand, dbType)
        {
